...
class RendezvousPrincipaleASS extends StatefulWidget {
  ...
  const RendezvousPrincipaleASS({super.key});
          ...
          return Column(
            ...
            children: [
              ...
              const Row(
                children: [
                  SizedBox(width: 100),
                  Text('Gérez vos rendez-vous ici',
                              ...
                              child: TextButton(
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          AddApointment(key: null, host: host, adb: adb),
                                    ),
                                  );
                                },
                                child: const Row(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                const Align(
                                  alignment: Alignment.topLeft,
                                  child: Text("Mardi 15 Avril 2025 ",
                                      style: TextStyle(
                                          fontSize: 15,
